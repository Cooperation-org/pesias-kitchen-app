        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://x.com/eatfoodrescue" 
                target="_blank" 
          ...
          <div>
            ...
            <address className="not-italic text-gray-400">
              <p className="mb-3">Email: info@pesiaskitchen.org</p>
              <p className="mb-3">Twitter: @eatfoodrescue</p>
              <p>
                <a href="https://www.pesiaskitchen.org" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">
                  www.pesiaskitchen.org
                </a>
              </p>
            </address>
          </div>
