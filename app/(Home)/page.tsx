        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-3xl'>
            ...
            <p className='text-xl text-blue-100 mb-8'>
              Merging food rescue with financial empowerment using GoodDollar
              (G$).
            </p>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Our innovative approach combines food rescue operations with
              digital financial rewards, creating a sustainable impact model.
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            <div className='bg-white p-6 rounded-lg shadow-sm border border-gray-200'>
              ...
              <p className='text-gray-600'>
                Join as a volunteer to sort, package, and distribute rescued
            ...
            <div className='bg-white p-6 rounded-lg shadow-sm border border-gray-200'>
              ...
              <p className='text-gray-600'>
                Verify your participation by scanning QR codes at distribution
                centers.
              </p>
            </div>
            ...
            <div className='bg-white p-6 rounded-lg shadow-sm border border-gray-200'>
              ...
              <p className='text-gray-600'>
                Receive GoodDollar (G$) rewards for your contributions, which
                can be used, donated, or traded.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <p className='text-gray-600 mb-4'>
                Our innovative approach uses NFTs to tokenize meal
                distributions, creating a transparent and sustainable funding
                mechanism.
              </p>
              ...
              <Button
                variant='link'
                asChild
                className='p-0 flex items-center group'
              >
            ...
            <div className='bg-white rounded-lg border border-gray-200 shadow-sm p-6 aspect-square flex items-center justify-center'>
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-500'>
                  Each token represents verified meals distributed to those in
                  need
                </p>
              </div>
            </div>
      ...
      <section className='py-16'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Through the combined efforts of our volunteers and partners, we're
      ...
      <section className='py-16 bg-blue-600 text-white'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl text-blue-100 mb-8 max-w-2xl mx-auto'>
            Join our community of volunteers and earn G$ rewards while helping
